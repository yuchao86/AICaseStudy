...
for i in range(300):
    ...
    if len(tmpSample) < sample_times * 160:
        ...
        torch.save(net_eval.state_dict(), "mountain_model/goodmodel2" + str(goodmodel_idx) + ".pth")
        goodmodel_idx += 1
    ...
    PATH = "mountain_model/model"+str(i)+".pth"
